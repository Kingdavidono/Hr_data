...
![format-termdate-1](assets/images/datetime_to_date.jpg)
...
![age_distribution](assets/images/age_distribution.PNG)
...
![age_group_count](assets/images/age_group_count.PNG)
...
![age_group_by_gender](assets/images/age_group_by_gender.PNG)
...
2)	The genders are fairly evenly distributed across departments. Overall, there are slightly more male employees.
3)	Employees within the range of 50+ old are the fewest in the company. The age group of 31-40 have the most employees in the company.
...
6)	Auditing has the highest turnover rate, followed by Legal, Engineering and Training. Business Development & Marketing have the lowest turnover rates.
...
10)	There are 182 job titles in the company, with Research Assistant II taking most of the employees (634) and Assistant Professor, Marketing Manager, Office Assistant IV, Associate Professor and VP of Training and Development taking just 1 employee each.
